...
void Directory::addFile(Node *node)
{
    ...
    node->setParent(this);
    this->notify("File " + node->getName() + " added to " + this->getName());
}
void Directory::addDirectory(Node * node)
{
    ...
    node->setParent(this);
    this->notify("Directory " + node->getName() + " added to " + this->getName());
}
void Directory::removeFile(std::string name)
{
    ...
    do{
        ...
        {
            this->notify("File " + it->current()->getName() + " removed from " + this->getName());
            delete it->current();
            files.erase(it->at(i));
            delete it;
            return;
...
void Directory::removeDirectory(std::string name)
{
    ...
    do{
        if(it->current()->getName() == name)
        {
            this->notify("Directory " + it->current()->getName() + " removed from " + this->getName());
            delete it->current();
